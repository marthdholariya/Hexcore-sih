...
-- Contains the demo records currently stored in skilltrack_db.

SET client_encoding = 'UTF8';
SET standard_conforming_strings = on;
SET search_path = '';

-- Data for Name: predictions; Type: TABLE DATA; Schema: analytics; Owner: postgres
--

COPY analytics.predictions (prediction_id, trainee_id, employment_id, prediction_type, probability_score, risk_level, model_version, prediction_date, key_factors) FROM stdin;
...
-- Data for Name: recommendations; Type: TABLE DATA; Schema: analytics; Owner: postgres
--

COPY analytics.recommendations (recommendation_id, user_id, user_type, entity_type, entity_id, recommendation_text, priority, status, created_at) FROM stdin;
...
-- Data for Name: skill_gap_analysis; Type: TABLE DATA; Schema: analytics; Owner: postgres
--

COPY analytics.skill_gap_analysis (gap_id, trainee_id, job_id, current_level, required_level, gap_level, detected_date) FROM stdin;
...
-- Data for Name: education; Type: TABLE DATA; Schema: education; Owner: postgres
--

COPY education.education (education_id, trainee_id, qualification, institution, field_of_study, start_date, end_date, grade_percentage) FROM stdin;
...
-- Data for Name: skills; Type: TABLE DATA; Schema: education; Owner: postgres
--

COPY education.skills (skill_id, skill_name, skill_category, sector, description) FROM stdin;
...
-- Data for Name: trainee_skills; Type: TABLE DATA; Schema: education; Owner: postgres
--

COPY education.trainee_skills (trainee_skill_id, trainee_id, skill_id, skill_level, source, verification_status, date_acquired, last_updated) FROM stdin;
...
-- Data for Name: employment; Type: TABLE DATA; Schema: employment; Owner: postgres
--

COPY employment.employment (employment_id, trainee_id, employer_id, job_role, joining_date, leaving_date, employment_type, location, training_related, employment_status) FROM stdin;
81000000-0000-0000-0000-000000000001	11000000-0000-0000-0000-000000000001	21000000-0000-0000-0000-000000000001	Junior Full Stack Developer	2025-07-15	\N	Full-time	Pune	t	Employed
81000000-0000-0000-0000-000000000002	11000000-0000-0000-0000-000000000002	21000000-0000-0000-0000-000000000003	Data Analyst	2025-08-01	\N	Full-time	Ahmedabad	t	Employed
81000000-0000-0000-0000-000000000003	11000000-0000-0000-0000-000000000003	21000000-0000-0000-0000-000000000002	Solar PV Technician	2025-06-10	\N	Full-time	Jaipur	t	Employed
81000000-0000-0000-0000-000000000004	11000000-0000-0000-0000-000000000004	21000000-0000-0000-0000-000000000001	Python Developer	2025-09-01	\N	Full-time	Bengaluru	t	Employed
81000000-0000-0000-0000-000000000005	11000000-0000-0000-0000-000000000005	21000000-0000-0000-0000-000000000002	Electrical Technician	2025-10-15	\N	Contract	Delhi	t	Employed
81000000-0000-0000-0000-000000000006	11000000-0000-0000-0000-000000000006	21000000-0000-0000-0000-000000000003	Digital Marketing Executive	2026-01-10	\N	Full-time	Mumbai	t	Employed
\.

-- Data for Name: employment_evidence; Type: TABLE DATA; Schema: employment; Owner: postgres
--

COPY employment.employment_evidence (evidence_id, employment_id, evidence_type, evidence_url, upload_date, verification_status, reviewer, review_date, comments) FROM stdin;
...
-- Data for Name: employment_verifications; Type: TABLE DATA; Schema: employment; Owner: postgres
--

COPY employment.employment_verifications (verification_id, employment_id, employer_id, verified_role, verified_joining_date, verified_status, verification_date, verified_by, comments) FROM stdin;
...
-- Data for Name: salary_history; Type: TABLE DATA; Schema: employment; Owner: postgres
--

COPY employment.salary_history (salary_history_id, employment_id, salary_amount, effective_date, salary_type, source) FROM stdin;
...
-- Data for Name: attrition_reasons; Type: TABLE DATA; Schema: followup; Owner: postgres
--

COPY followup.attrition_reasons (reason_id, reason_name, description) FROM stdin;
...
-- Data for Name: employment_status; Type: TABLE DATA; Schema: followup; Owner: postgres
--

COPY followup.employment_status (status_id, status_name, description) FROM stdin;
...
-- Data for Name: followup_responses; Type: TABLE DATA; Schema: followup; Owner: postgres
--

COPY followup.followup_responses (response_id, followup_id, current_employment_status_id, current_job, salary, job_changed, apprenticeship, further_education, unemployed, comments) FROM stdin;
95000000-0000-0000-0000-000000000001	94000000-0000-0000-0000-000000000001	91000000-0000-0000-0000-000000000001	Junior Full Stack Developer	40000.00	f	f	f	f	Trainee is employed in a role related to full stack web development training.
95000000-0000-0000-0000-000000000002	94000000-0000-0000-0000-000000000002	91000000-0000-0000-0000-000000000001	Data Analyst	45000.00	f	f	f	f	Trainee is employed as a data analyst in a training-related role.
95000000-0000-0000-0000-000000000003	94000000-0000-0000-0000-000000000003	91000000-0000-0000-0000-000000000001	Solar PV Technician	35000.00	f	f	f	f	Trainee is working as a solar PV technician after completing relevant training.
95000000-0000-0000-0000-000000000004	94000000-0000-0000-0000-000000000004	91000000-0000-0000-0000-000000000001	Python Developer	50000.00	t	f	f	f	Trainee changed to a Python development role after completing technical training.
95000000-0000-0000-0000-000000000005	94000000-0000-0000-0000-000000000005	91000000-0000-0000-0000-000000000001	Electrical Technician	30000.00	f	f	f	f	Trainee is employed as an electrical technician in a training-related role.
\.

-- Data for Name: followups; Type: TABLE DATA; Schema: followup; Owner: postgres
--

COPY followup.followups (followup_id, trainee_id, milestone_month, scheduled_date, response_date, status) FROM stdin;
...
94000000-0000-0000-0000-000000000006	11000000-0000-0000-0000-000000000006	3	2026-04-10	\N	Pending
\.

-- Data for Name: non_placement_reasons; Type: TABLE DATA; Schema: followup; Owner: postgres
--

COPY followup.non_placement_reasons (reason_id, reason_name, description) FROM stdin;
...
-- Data for Name: job_market_data; Type: TABLE DATA; Schema: jobs; Owner: postgres
--

COPY jobs.job_market_data (market_data_id, skill_id, location, sector, job_role, time_period, demand_level, job_postings_count, trend) FROM stdin;
...
-- Data for Name: job_skills; Type: TABLE DATA; Schema: jobs; Owner: postgres
--

COPY jobs.job_skills (job_skill_id, job_id, skill_id, required_level) FROM stdin;
...
-- Data for Name: jobs; Type: TABLE DATA; Schema: jobs; Owner: postgres
--

COPY jobs.jobs (job_id, employer_id, title, sector, location, district, state, employment_type, salary_min, salary_max, experience_required, education_required, description, posted_date, closing_date, status) FROM stdin;
...
-- Data for Name: data_quality_issues; Type: TABLE DATA; Schema: planning; Owner: postgres
--

COPY planning.data_quality_issues (issue_id, entity_type, entity_id, issue_type, issue_description, severity, status, detected_date, resolved_date) FROM stdin;
9b000000-0000-0000-0000-000000000001	Trainee	11000000-0000-0000-0000-000000000001	Missing Evidence	Employment evidence document has not been uploaded for the trainee record.	Medium	Open	2026-02-20	\N
...
9b000000-0000-0000-0000-000000000003	Trainee Skill	53000000-0000-0000-0000-000000000005	Outdated Skill Verification	Skill verification information requires an updated verification review.	Medium	Open	2026-02-23	\N
9b000000-0000-0000-0000-000000000004	Follow-up	94000000-0000-0000-0000-000000000006	Pending Response	Scheduled trainee follow-up has not yet received a response.	Low	Open	2026-02-24	\N
...
-- Data for Name: training_effectiveness; Type: TABLE DATA; Schema: planning; Owner: postgres
--

COPY planning.training_effectiveness (effectiveness_id, course_id, provider_id, completion_rate, placement_rate, retention_rate, avg_starting_salary, effectiveness_score, calculated_date) FROM stdin;
...
-- Data for Name: whatif_scenarios; Type: TABLE DATA; Schema: planning; Owner: postgres
--

COPY planning.whatif_scenarios (scenario_id, scenario_name, description, target_course_id, target_skill_id, assumptions, estimated_impact, confidence_level, created_at) FROM stdin;
...
COPY public.employers (employer_id, user_id, company_name, industry_sector, contact_person, phone, email, address, district, state, status) FROM stdin;
...
COPY public.trainees (trainee_id, user_id, dob, gender, address, district, state, profile_created_at) FROM stdin;
...
-- Data for Name: training_providers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.training_providers (provider_id, user_id, name, contact_person, phone, email, address, district, state, status) FROM stdin;
...
COPY public.users (user_id, name, email, phone, password_hash, role, account_status, created_at, updated_at) FROM stdin;
...
-- Data for Name: assessments; Type: TABLE DATA; Schema: training; Owner: postgres
--

COPY training.assessments (assessment_id, enrollment_id, assessment_type, assessment_date, score, max_score, pass_fail, result) FROM stdin;
64000000-0000-0000-0000-000000000001	62000000-0000-0000-0000-000000000001	Technical	2023-10-15	84.00	100.00	t	Pass
64000000-0000-0000-0000-000000000002	62000000-0000-0000-0000-000000000001	Final	2024-01-10	88.00	100.00	t	Pass
64000000-0000-0000-0000-000000000003	62000000-0000-0000-0000-000000000002	Theory	2022-08-10	76.00	100.00	t	Pass
64000000-0000-0000-0000-000000000004	62000000-0000-0000-0000-000000000002	Final	2022-09-30	82.00	100.00	t	Pass
64000000-0000-0000-0000-000000000005	62000000-0000-0000-0000-000000000003	Technical	2024-10-15	91.00	100.00	t	Pass
64000000-0000-0000-0000-000000000006	62000000-0000-0000-0000-000000000003	Final	2025-01-10	94.00	100.00	t	Pass
64000000-0000-0000-0000-000000000007	62000000-0000-0000-0000-000000000004	Python	2023-09-15	79.00	100.00	t	Pass
64000000-0000-0000-0000-000000000008	62000000-0000-0000-0000-000000000004	Final	2023-11-10	86.00	100.00	t	Pass
64000000-0000-0000-0000-000000000009	62000000-0000-0000-0000-000000000005	Practical	2022-10-15	68.00	100.00	t	Pass
64000000-0000-0000-0000-000000000010	62000000-0000-0000-0000-000000000005	Final	2022-12-10	72.00	100.00	t	Pass
64000000-0000-0000-0000-000000000011	62000000-0000-0000-0000-000000000006	Communication	2023-09-10	89.00	100.00	t	Pass
64000000-0000-0000-0000-000000000012	62000000-0000-0000-0000-000000000008	Theory	2025-03-15	64.00	100.00	t	Pass
\.

-- Data for Name: attendance; Type: TABLE DATA; Schema: training; Owner: postgres
--

COPY training.attendance (attendance_id, enrollment_id, attendance_date, is_present, total_sessions, sessions_attended) FROM stdin;
63000000-0000-0000-0000-000000000001	62000000-0000-0000-0000-000000000001	2023-08-31	t	20	19
63000000-0000-0000-0000-000000000002	62000000-0000-0000-0000-000000000001	2023-10-31	t	20	18
63000000-0000-0000-0000-000000000003	62000000-0000-0000-0000-000000000002	2022-07-31	t	20	19
63000000-0000-0000-0000-000000000004	62000000-0000-0000-0000-000000000002	2022-09-30	t	20	17
63000000-0000-0000-0000-000000000005	62000000-0000-0000-0000-000000000003	2024-08-31	t	20	20
63000000-0000-0000-0000-000000000006	62000000-0000-0000-0000-000000000003	2024-11-30	t	20	19
63000000-0000-0000-0000-000000000007	62000000-0000-0000-0000-000000000004	2023-08-31	t	20	18
63000000-0000-0000-0000-000000000008	62000000-0000-0000-0000-000000000004	2023-10-31	t	20	17
63000000-0000-0000-0000-000000000009	62000000-0000-0000-0000-000000000005	2022-08-31	t	20	18
63000000-0000-0000-0000-000000000010	62000000-0000-0000-0000-000000000005	2022-11-30	t	20	16
63000000-0000-0000-0000-000000000011	62000000-0000-0000-0000-000000000006	2023-08-31	t	20	19
63000000-0000-0000-0000-000000000012	62000000-0000-0000-0000-000000000006	2023-09-30	t	20	18
63000000-0000-0000-0000-000000000013	62000000-0000-0000-0000-000000000007	2024-03-31	t	20	18
63000000-0000-0000-0000-000000000014	62000000-0000-0000-0000-000000000007	2024-05-31	t	20	19
63000000-0000-0000-0000-000000000015	62000000-0000-0000-0000-000000000008	2025-02-28	t	20	17
63000000-0000-0000-0000-000000000016	62000000-0000-0000-0000-000000000008	2025-03-31	f	20	14
\.

-- Data for Name: certificates; Type: TABLE DATA; Schema: training; Owner: postgres
--

COPY training.certificates (certificate_id, enrollment_id, certificate_name, certificate_number, issue_date, expiry_date, issuing_organization, verification_status, certificate_url) FROM stdin;
65000000-0000-0000-0000-000000000001	62000000-0000-0000-0000-000000000001	Full Stack Web Development Certificate	ST-FSWD-2024-0001	2024-01-15	\N	SkillForge Training Centre	Verified	\N
65000000-0000-0000-0000-000000000002	62000000-0000-0000-0000-000000000002	Digital Marketing Certificate	ST-DM-2022-0002	2022-10-05	\N	SkillForge Training Centre	Verified	\N
65000000-0000-0000-0000-000000000003	62000000-0000-0000-0000-000000000003	Full Stack Web Development Certificate	ST-FSWD-2025-0003	2025-01-15	\N	SkillForge Training Centre	Verified	\N
65000000-0000-0000-0000-000000000004	62000000-0000-0000-0000-000000000004	Python and Data Analytics Certificate	ST-PDA-2023-0004	2023-11-15	\N	SkillForge Training Centre	Verified	\N
65000000-0000-0000-0000-000000000005	62000000-0000-0000-0000-000000000005	Solar PV Technician Certificate	ST-SPV-2022-0005	2022-12-15	\N	FutureSkills Institute	Verified	\N
65000000-0000-0000-0000-000000000006	62000000-0000-0000-0000-000000000006	Customer Service Professional Certificate	ST-CSP-2023-0006	2023-10-15	\N	FutureSkills Institute	Verified	\N
65000000-0000-0000-0000-000000000007	62000000-0000-0000-0000-000000000007	Python and Data Analytics Certificate	ST-PDA-2024-0007	2024-06-15	\N	SkillForge Training Centre	Verified	\N
\.

-- Data for Name: courses; Type: TABLE DATA; Schema: training; Owner: postgres
--

COPY training.courses (course_id, provider_id, course_name, description, sector, job_role, duration, course_level, status) FROM stdin;
...
-- Data for Name: enrollments; Type: TABLE DATA; Schema: training; Owner: postgres
--

COPY training.enrollments (enrollment_id, trainee_id, course_id, enrollment_date, start_date, end_date, completion_status, completion_date) FROM stdin;
...
62000000-0000-0000-0000-000000000008	11000000-0000-0000-0000-000000000006	61000000-0000-0000-0000-000000000003	2025-01-05	2025-01-15	2025-04-15	In Progress	\N
\.
