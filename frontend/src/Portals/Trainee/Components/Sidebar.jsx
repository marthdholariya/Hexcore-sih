...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Main Sidebar - Enforced fixed width to eliminate white gap */}
      <aside
      ...
      >
        ...
        <div className="p-5 border-b border-slate-800 flex items-center space-x-3 shrink-0">
          ...
          <div className="min-w-0">
            <h1 className="text-sm font-bold text-white tracking-wide truncate">Trainee Portal</h1>
        ...
        {/* Footer with User Badge & Sign Out Button */}
          ...
          <div className="p-2.5 rounded-xl bg-slate-800/60 border border-slate-800 flex items-center justify-between">
            <div className="flex items-center space-x-2 min-w-0">
              ...
              <div className="truncate">
                <p className="text-[11px] font-bold text-slate-200 truncate">Rahul Patil</p>
                <p className="text-[9px] text-slate-400 truncate">MH-2024-TR-84920</p>
              </div>
            </div>
